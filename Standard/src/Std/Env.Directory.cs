...
{
    public static string GetDirectory(SpecialDirectory directory, Environment.SpecialFolderOption option)
    {
        switch (directory)
        {
            case SpecialDirectory.Downloads:
                ...
                if (option == Environment.SpecialFolderOption.Create && !Fs.DirectoryExists(folder))
                {
                ...
                return folder;
            default:
                return Environment.GetFolderPath((Environment.SpecialFolder)directory, option);
        }
    }
    ...
    public static string GetDirectory(SpecialDirectory directory)
    {
        switch (directory)
        {
            case SpecialDirectory.Downloads:
