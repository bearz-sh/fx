...
public class CommandLineApplicationBuilder
{
    ...
    public CommandLineApplicationBuilder AddCommand(Command command, Type commandHandlerType)
    {
        AddCommandHandler(this, command);
    ...
    public CommandLineApplicationBuilder AddCommand<TCommand>(Type commandHandlerType)
        where TCommand : Command, new()
    {
        this.AddCommand(new TCommand());
    ...
    public CommandLineApplicationBuilder UseCommandHandler(Type commandType, Type commandHandlerType)
    {
    ...
    public CommandLineApplicationBuilder UseCommandHandler<TCommand, THandler>()
